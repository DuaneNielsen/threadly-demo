...
check docker "required — for monitoring stack (Fluent Bit + Loki + Grafana)"
...
echo ""
echo "  Quick start:"
echo "    1. ./deploy.sh v1.1                          # deploy buggy app"
echo "    2. cd monitoring && docker compose up -d      # start monitoring stack"
echo "    3. npm start                                  # start demo server"
echo ""
